...
?>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6"><input name="currency" value="₹<?php echo str_replace('$', '', $data['currency']); ?>" class="form-control" type="text"></div>
            </div>
			...
			<p>There are two things you must replace for it to work</p>
      <p>1) The Recipient phone number with <strong>[TO]</strong></p>
      <p>2) The Message with <strong>[MESSAGE]</strong></p>
